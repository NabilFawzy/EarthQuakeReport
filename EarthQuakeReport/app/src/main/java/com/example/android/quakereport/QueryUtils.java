...
public final class QueryUtils {
    ...
    */
    ...
    public static ArrayList<EarthquakeDetails> fetchEarthquakeData(String requestUrl) {
       ...
       ArrayList<EarthquakeDetails> earthquakes = extractFeatureFromJson(jsonResponse);
    ...
    private static ArrayList<EarthquakeDetails> extractFeatureFromJson(String earthquakeJSON) {
        ...
        ArrayList<EarthquakeDetails>quakes=new ArrayList<EarthquakeDetails>();
        try {
            ...
            if (featureArray.length() > 0) {
                for(int i=0;i<featureArray.length();i++){
                    ...
                    EarthquakeDetails e=new EarthquakeDetails(mag, place, time,url);
                   quakes.add(e);
                }
   ...
   /* public static ArrayList<EarthquakeDetails> extractEarthquakes() {
        ...
        try {
            ...
            for(int i=0;i<features.length();i++){
                ...
                double mag=  J.optJSONObject("properties").optDouble("mag");

                String place=  J.optJSONObject("properties").optString("place");
                long time=  J.optJSONObject("properties").optLong("time");
                String url=J.optJSONObject("properties").optString("url");
                Date dateObject=new Date(time);
                SimpleDateFormat dateFormatter = new SimpleDateFormat("DD MMM, yyyy");
                earthquake=new EarthquakeDetails(mag,place,time,url);
                earthquake.formatDate(dateObject);
                earthquake.formatTime(dateObject);
